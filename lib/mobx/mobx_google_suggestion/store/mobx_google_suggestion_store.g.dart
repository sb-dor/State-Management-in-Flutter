...
mixin _$MobxGoogleSuggestionStoreData on _MobxGoogleSuggestionStore, Store {
  late final _$suggestionsAtom =
      Atom(name: '_MobxGoogleSuggestionStore.suggestions', context: context);
  ...
  late final _$loadingApiAtom =
      Atom(name: '_MobxGoogleSuggestionStore.loadingApi', context: context);
  ...
  Future<void> loadDataFromGoogle(String data) {
    return _$loadDataFromGoogleAsyncAction
        .run(() => super.loadDataFromGoogle(data));
  }
